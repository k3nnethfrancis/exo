...
Exograph UI should feel like a precise workstation, not a technical plan review. Screens should show the user's next decision as a control, not as a paragraph.
...
- Make unavailable choices visibly unavailable and non-selectable. Do not preselect a command, provider, or terminal dependency that Exograph cannot detect as usable.
