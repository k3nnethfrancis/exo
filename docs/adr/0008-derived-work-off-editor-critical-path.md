...
QMD now runs through its SDK in utility processes. Exograph carries a narrow patched
...
The patch is reproducible through pnpm, keeps the public Exograph command routes
