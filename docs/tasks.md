...
- [ ] Extract renderer state machines from `App.tsx`: workspace bootstrap, terminal sessions, workspace settings controller, workspace mutations, and pane/drop orchestration.
