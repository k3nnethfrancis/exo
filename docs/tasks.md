...
- [ ] Complete `EXO-ISSUE-037` terminal parity follow-up after multi-agent review: stale tmux state persistence, configurable MCP read caps, direct terminal-quality CI gate, and diagnostics gaps.
