...
- Resolution:
  ...
  - 2026-07-11 follow-up for GitHub #2: removed the old editor Inspector panel/action and its persisted layout state now that backlinks/references are available inline.
