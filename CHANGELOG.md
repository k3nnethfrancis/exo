...
- Fixes Monitor Mode live additions so new terminal sessions converge on the balanced monitor grid instead of repeatedly splitting the active pane into skinny columns.
