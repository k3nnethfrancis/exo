...
- Fixes Monitor Mode live terminal additions so added sessions converge to the same balanced grid layout as entering Monitor Mode with the full session list.
