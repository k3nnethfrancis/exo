...
- Fixes Monitor Mode live terminal additions so new sessions converge on the balanced monitor grid instead of repeatedly splitting the focused pane in one direction.
