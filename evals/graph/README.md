...
This is Exograph's internal, hardware-stamped regression suite for the graph scene.
It measures Exograph only. It is not a public cross-library benchmark or an AI
evaluation.
