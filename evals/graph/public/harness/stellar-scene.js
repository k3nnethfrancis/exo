...
export const STELLAR_PRESENTATION_PROFILES = Object.freeze({
  'evaluation-v1': Object.freeze({
    id: 'evaluation-v1', curve: 'fixed', zoomExponent: 0, zoomMin: 1, zoomMax: 1,
...
export function resolveNodeBaseRadius(degree, profileOrId = 'explore-v1') {
  ...
  if (profile.curve === 'fixed') return clamp(3.2 + Math.sqrt(Math.max(1, safeDegree)) * 0.88, 3.6, 11.5);
