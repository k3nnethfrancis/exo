...
} from './public/harness/stellar-scene.js';
...
assert.equal(presentationProfileHash('evaluation-v1'), presentationProfileHash(resolvePresentationProfile('evaluation-v1')));
assert.notEqual(presentationProfileHash('evaluation-v1'), presentationProfileHash('explore-v1'));
assert(Object.isFrozen(STELLAR_PRESENTATION_PROFILES));
assert(Object.isFrozen(resolvePresentationProfile('capture-v1')));
assert.equal(resolveNodeBaseRadius(0, 'evaluation-v1'), 4.08);
assert.equal(resolvePresentationZoom(100, 'evaluation-v1'), 1);
assert.equal(resolveNodeScreenRadius(16, 0.5, 'evaluation-v1'), resolveNodeScreenRadius(16, 8, 'evaluation-v1'));
