...
import type { NoteKnowledge, TreeNode, WorkspaceModel } from "@exo/core";
...
export function buildGraphReferences(knowledge: NoteKnowledge | null): MarkdownGraphReferences | null {
  if (!knowledge) {
    return null;
  }
...
export function graphReferencesForMarkdownMode(
  ...
  return buildGraphReferences(knowledge);
}
