...
const api: DesktopApi = {
  workspace: {
    ...
    markOnboardingProfileStep: (input) => invokeDesktop("workspace:mark-onboarding-profile-step", input),
    ...
    previewProfile: (input) => invokeDesktop("workspace:preview-profile", input),
    copyProfile: (input) => invokeDesktop("workspace:copy-profile", input),
    createProfileApplyProposal: (input) => invokeDesktop("workspace:create-profile-apply-proposal", input),
    ...
    addLocalPlugin: (input) => invokeDesktop("workspace:add-local-plugin", input),
    removeLocalPlugin: (input) => invokeDesktop("workspace:remove-local-plugin", input),
    replaceLocalPlugin: (input) => invokeDesktop("workspace:replace-local-plugin", input),
    ...
    listProposals: () => invokeDesktop("workspace:list-proposals"),
