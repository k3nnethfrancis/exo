...
import type { InvocationProcessOwnership } from "@exograph/core";
  ...
  constructor(
    ...
    child.once("close", (exitCode) => {
      ...
      void this.finishAfterProcessGroupExit(event).catch((error) => {
        ...
        console.error("[exograph] invocation process-group finalization failed", this.finalizationError);
      });
    });
  }
...
const INVOCATION_OWNER_ENV = "EXOGRAPH_INVOCATION_OWNER_TOKEN";
