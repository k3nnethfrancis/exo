...
async function openRelatedNoteFromInlineBacklink(page: Page) {
  await expect(page.getByTestId("markdown-graph-references")).toBeVisible();
...
async function readFirstTerminalOfKind(page: Page, kind: "shell" | "claude" | "codex") {
