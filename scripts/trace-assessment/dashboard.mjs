    ...
    <section class="view" id="panel-overview" data-panel="overview" role="tabpanel" aria-labelledby="tab-overview">
      ...
      <div class="dashboard-grid">
        ...
        <div class="stack">
          ...
          </div><details class="method"><summary>How to read “agreement”</summary><p>Exact overlap is deliberately strict. It compares normalized strings across outcome, types, properties, relations, path defaults, validation rules, and evidence paths. Therefore 9.8% does not mean the agents understood only 9.8% of the same structure. It means they wrote the same exact feature about one time in ten. The exploratory Inter-run agreement score is ${decimal(assessment.agreement.overall.interRunAgreement)}: near zero means exact inclusion consensus is close to chance after correcting for the large number of absent features. Neither number is a quality score.</p></details></section>
        </div>
      </div>
    </section>
